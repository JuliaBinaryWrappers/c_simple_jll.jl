# Autogenerated wrapper script for c_simple_jll for x86_64-w64-mingw32
...
const libc_simple_splitpath = ["bin", "libc_simple.dll"]
...
const libc_simple = "libc_simple.dll"


# Relative path to `c_simple`
const c_simple_splitpath = ["bin", "c_simple.exe"]
